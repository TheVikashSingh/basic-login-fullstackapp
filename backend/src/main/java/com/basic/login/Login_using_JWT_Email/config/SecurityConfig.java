package com.basic.login.Login_using_JWT_Email.config;


import com.basic.login.Login_using_JWT_Email.filter.JwtRequestFilter;
...
public class SecurityConfig {
    ...
    public CorsFilter corsFilter(){
        return new CorsFilter(corsConfigurationService());
    }

    @Bean
    public CorsConfigurationSource corsConfigurationService() {
