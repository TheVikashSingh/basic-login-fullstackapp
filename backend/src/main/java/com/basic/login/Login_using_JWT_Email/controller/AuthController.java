...
import com.basic.login.Login_using_JWT_Email.dto.AuthRequest;
import com.basic.login.Login_using_JWT_Email.dto.AuthResponse;
import com.basic.login.Login_using_JWT_Email.dto.ResetPasswordRequest;
...
public class AuthController {
    ...
    public void sendVerifyOTP(Authentication authentication){
        try{
            profileService.sendOTP(authentication.getName());
        }catch (Exception ex){
            ex.printStackTrace();
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR,ex.getMessage());
        }
    ...
    public void verifyEmailWithOTP(@RequestBody Map<String,Object> request,
